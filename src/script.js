...
// Light 2
const pointLight2 = new THREE.PointLight(0x4aff, 0.2);
pointLight2.position.set(0.86, -0.19, -0.09);
...
// Light 3
const pointLight3 = new THREE.PointLight(0xe62969, 0.2);
pointLight3.position.set(-2.51, 0.35, -1.38);
pointLight3.intensity = 3.9;
